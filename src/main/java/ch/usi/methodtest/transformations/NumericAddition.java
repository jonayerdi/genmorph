...
public class NumericAddition extends AbstractSingleTransformation {

    public final double number;

    public NumericAddition(final String[] parameters) {
        this(Double.parseDouble(parameters[0]));
        assertAlways(parameters.length == 1, "NumericAddition takes exactly one parameter");
    }

    public NumericAddition(final double number) {
        this.number = number;
    }
