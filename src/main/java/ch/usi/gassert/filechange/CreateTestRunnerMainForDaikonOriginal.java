 ...
 */
public class CreateTestRunnerMainForDaikonOriginal {
    ...
    public static void main(final String[] args) throws Throwable {
        ...
        javaSB.append("package " + CreateTestRunnerMainForDaikonOriginal.class.getPackage().getName() + ";");
        ...
        final String outputFolder = pathJar.split("/build")[0] + "/src/test/java/" + CreateTestRunnerMainForDaikonOriginal.class.getPackage().getName().replaceAll("\\.", "/");
    ...
    private static String getInvocations() throws Throwable {
        ...
        pathJar = loader.getResource(CreateTestRunnerMainForDaikonOriginal.class.getPackage().getName() + "/CreateTestRunnerMainForDaikon.class").getFile().split("file:")[1].split("!")[0];
        // create url
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (zipEntry.getName().endsWith(".class")) {
                ...
                if (!className.contains("Test") || !className.startsWith(CreateTestRunnerMainForDaikonOriginal.class.getPackage().getName())) {
                    continue;
                }
